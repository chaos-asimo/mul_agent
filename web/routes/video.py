...
优化要求：
1. 保持原始意图和主题
2. 按照推荐结构生成：[主体] + [动作] + [场景] + [镜头运动] + [光线] + [风格]
   - 主体：明确描述视频中的主要对象（人物、物体、生物等）
   - 动作：描述主体正在进行的动作或行为
   - 场景：描述背景环境和空间设置
   - 镜头运动：描述摄像机的运动方式（如推镜头、拉镜头、摇镜头、移动镜头等）
   - 光线：描述光照条件和氛围（如柔和自然光、戏剧性侧光、霓虹灯光等）
   - 风格：描述整体视觉风格（如电影感、动画风格、写实风格、复古风格等）
3. 使用更具表现力的语言
4. 保持提示词简洁但有画面感
